    ...
    return (
        <AppShell title="Reports">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                <StatCard
                    label="Sales Total"
                    value={currency(summary.sales_total)}
                />
                <StatCard
                    label="Cash In"
                    value={currency(summary.cash_in_total)}
                />
                <StatCard
                    label="Cash Out"
                    value={currency(summary.cash_out_total)}
                />
                <StatCard
                    label="Profit Estimate"
                    value={currency(summary.profit_estimate)}
                />
            </div>
                    ...
                    <CardContent className="space-y-3">
                        {product_movement.slice(0, 8).map((product: any) => (
                            ...
                            >
                                ...
                                <span>
                                    Sold {product.sold_quantity ?? 0} / Bought{' '}
