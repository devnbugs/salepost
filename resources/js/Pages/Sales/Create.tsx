...
export default function SalesCreate({
    ...
    const total =
        data.items.reduce((carry: number, item: any) => {
            return (
                carry +
    ...
    return (
        <AppShell title="Create Sale">
            <PageHeader
                title="Create Sale"
                description="Register a draft or completed sale with multiple materials and payment details."
            />
            <Card>
                <CardContent className="space-y-6 p-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setData('transport_fee', e.target.value)
                                }
                            />
                        </div>
                        <div>
                    ...
                    <Button
                        disabled={processing}
                        onClick={() => post(route('sales.store'))}
                    >
                        Save Sale
                    </Button>
                </CardContent>
